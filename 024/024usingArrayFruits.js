...
fruits.push("Melocotón")//Añadimos melocotón al final
 ...
 for (let i = 0; i < fruits.length; i++) {  //Mostrar el array elemento a elemento con for clásico
    alert(fruits[i]);
 }
...
for (let key of fruits) { //Mostrar cada elemento con for of o for in, lo que considere más adecuado.
    alert(key);
  }